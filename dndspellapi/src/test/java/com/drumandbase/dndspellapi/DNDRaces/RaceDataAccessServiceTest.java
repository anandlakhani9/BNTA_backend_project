...
class RaceDataAccessServiceTest {
    ...
    void setup(){
        ...
        jdbcTemplate.execute(
                "INSERT INTO dndraces (race_name, race_description) VALUES ('Dwarf','fgsdu');");
    }
    @Test
    List<Race> selectAllRaces() {
        ...
        List<Race> expected = List.of(new Race(8, "Dwarf", "fgsdu"));
        //then
    ...
    void itShouldSelectRaceById() {
        ...
        System.out.println(actual);
        Optional<Race> expected = Optional.of(new Race(1, "Dwarf", "fgsdu"));
        //then
